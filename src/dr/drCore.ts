...
export const CarrelageModule = makeDRModule<CarrelageParams, CarrelageResult>({
  ...
  label: "Carrelage",
  inputSpec: {
    longueur: { label: "Longueur pièce (m)", min: 0.01, required: true },
    largeur: { label: "Largeur pièce (m)", min: 0.01, required: true },
    carreauA: { label: "Longueur carreau (m)", min: 0.01, required: true },
    carreauB: { label: "Largeur carreau (m)", min: 0.01, required: true },
...
export const PeintureModule = makeDRModule<PeintureParams, PeintureResult>({
  ...
  inputSpec: {
    longueur: { label: "Longueur pièce (m)", min: 0.01, required: true },
    largeur: { label: "Largeur pièce (m)", min: 0.01, required: true },
    hauteur: { label: "Hauteur murs (m)", min: 0.01, required: true },
...
export const PlacoModule = makeDRModule<PlacoParams, PlacoResult>({
  ...
  label: "Placo",
  inputSpec: {
    longueur: { label: "Longueur mur (m)", min: 0.01, required: true },
    hauteur: { label: "Hauteur mur (m)", min: 0.01, required: true },
...
export const BardageModule = makeDRModule<BardageParams, BardageResult>({
  ...
  label: "Bardage",
  inputSpec: {
    largeur: { label: "Largeur façade (m)", min: 0.01, required: true },
    hauteur: { label: "Hauteur façade (m)", min: 0.01, required: true },
...
export const PlomberieModule = makeDRModule<PlomberieParams, PlomberieResult>({
  ...
  inputSpec: {
    ...
    longAlimMoy: { label: "Long. alim. moyenne (m)", min: 0.01, default: 8, required: true },
    longEvacMoy: { label: "Long. évac. moyenne (m)", min: 0.01, default: 5, required: true },
